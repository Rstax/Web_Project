...
if (isset($_POST['form_submitted'])) {
    ...
    $sql = "SELECT * FROM users WHERE `role_id`=1 && `email_address`='" . $email_address . "' && `password` = '" . $password . "'";
    $result = $db->query($sql);
...
<body>
    ...
    <div class="midnav" >
        ...
        <center>
        <form style="margin-top: 0%;padding-top: 0%;" action="" name = "form1" method="POST" onSubmit="return check(this)" >
            <table border="0" width="550" >
                <tr>
                    <th align="left" colspan="8" style="font-size: 18px;padding-bottom: 20px;">email_address:<br><input type="text" required="" name="email_address" id="Text" placeholder=" email_address"></th>
                </tr>
                <tr>
                    <th align="left" colspan="8" style="font-size: 18px;"> Password:<br><input type="password" required="" name="password" id="Password" placeholder=" Password"><br>
                        <a id="Forgot" href="ForgotPassword.html">Forgot Password?</a></th>
                </tr>
                <tr></tr>
            </table>
